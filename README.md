...
![Noise robustness chart](results/noise_robustness_chart.png)

The chart above is generated by the script and saved in [results/noise_robustness_chart.png](results/noise_robustness_chart.png).
